        ...
        <div className="p-4 mt-4">
          <div className="flex justify-between items-center mb-4">
            <h4 className="text-xl font-semibold">
              Your Cart <i className="ri-shopping-cart-2-line"></i>
            </h4>
            <button
              className="text-gray-600 hover:text-gray-900"
              onClick={() => onClose()}>
              <i className="ri-xrp-fill bg-black p-1 text-white" />
            </button>
          </div>
          {/* CART DETAILS 🛒 */}
                ...
                return (
                  <div
                    ...
                    <div className="flex items-center">
                      <span className="mr-4 px-1 bg-primary text-white rounded-full hover:bg-red-800">
                        0{idx + 1}
                      </span>
                      <img
                        src={item.image}
